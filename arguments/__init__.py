...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.deformation_update_interval = 100
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.student_lr_multiplier = 1.0        # Student netword learning rate multiplier
        self.student_lr_decay_multiplier = 1.0  # Student network learning rate decay multiplier
        ...
        self.split_dynamic=False

        # reduced_3dgs parameters
