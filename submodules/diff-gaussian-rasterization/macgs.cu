...
#include <glm/glm.hpp>
#include "macgs.h"
#include "macgs/kmeans.h"
#include "macgs/redundancy_score.h"
#include "macgs/sh_culling.h"	
...
torch::Tensor MACGS::calculatePixelSize(
...
MACGS::assignFinalRedundancyValue(
